  ...
  return (
    <>
      ...
      <div className="bg-primary text-primary-foreground text-xs py-2">
        <div className="container mx-auto flex flex-wrap items-center justify-between px-6 gap-2">
          <div className="flex items-center gap-6">
            <a href="mailto:contact@khayrafm.com" className="flex items-center gap-1.5 hover:opacity-80">
            ...
            <a href="tel:+971508054220" className="flex items-center gap-1.5 hover:opacity-80">
              <svg className="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
              +971 50 805 4220
            </a>
          </div>
          <span className="hidden sm:block">10 Floor, Corniche Building, Al HISN, Abu Dhabi, UAE</span>
        </div>
      </div>
        ...
        <div className="container mx-auto flex items-center justify-between px-6 py-3">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden sm:flex items-center gap-2 rounded-lg bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground transition-all hover:shadow-lg hover:shadow-primary/20"
            >
