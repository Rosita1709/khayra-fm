        ...
        <div className="max-w-3xl">
          ...
          >
            ...
            <a
              ...
              className="flex items-center gap-2 rounded-lg border border-border bg-card/50 px-8 py-4 font-display text-sm font-semibold tracking-wide text-foreground transition-all hover:border-primary/40 hover:bg-card"
            >
